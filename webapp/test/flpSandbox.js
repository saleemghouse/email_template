						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#emailtemplate-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"emailtemplate-display": {
								...
								"action": "display",
								"description": "An email template generation application .",
								"title": "Template Maintenance ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=emailtemplate",
									"url": sap.ui.require.toUrl("emailtemplate")
								}
							}
						}
					}
